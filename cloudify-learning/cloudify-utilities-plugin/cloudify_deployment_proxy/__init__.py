...
class DeploymentProxyBase(object):
    ...
    def create_deployment(self):
        ...
        create_config_item_per_bf(ctx, self.deployment_id, self.deployment_inputs)
    ...
    def delete_deployment(self):
        ...
        delete_config_item(ctx, self.deployment_id)
    ...
    def post_execute_node_instance_proxy(self):
        ...
        for node_instance in node_instances:
            if node_instance_id and \
                ...
                continue
            create_config_item_per_node(ctx, self.blueprint_id, node_instance.get('id'),node_instance.get('runtime_properties'))
    ...
    def post_execute_deployment_proxy(self):
        ...
        try:
            ...
            update_config_item_per_bf(ctx, dep_outputs)
